        ...
        <>
            <div className="relative h-40 w-full overflow-hidden bg-black mt-12 text-white flex items-center">
                <div className="absolute inset-y-0 right-0 flex items-center">
                    <p className="animate-slide-right-to-left text-3xl md:text-8xl font-bold whitespace-nowrap">
                        Hire Me! Hire Me! Hire Me! Hire Me! Hire Me! Hire Me!
                    </p>
                </div>
            </div>

            <div className="grid md:grid-cols-2 gap-12 p-6 md:p-24 space-y-12">
                <div className="flex items-center justify-center md:justify-start mx-auto">
                    <p className="text-lg md:text-3xl text-center md:text-left">
                        Ready to infuse fresh energy into your projects? Discover the enthusiasm and potential of a dedicated newcomer eager to make a mark. With a strong foundation in web development and a passion for learning, I’m committed to driving your projects forward. Let’s collaborate to unlock new possibilities and achieve exceptional results. Don't miss out on this opportunity to bring innovative ideas and solutions to your team.
                    </p>
                </div>
                <div className="px-8 md:px-0 flex flex-col gap-10">
                    <div className="hover:-rotate-0 group border-sky-900 border-4 overflow-hidden rounded-2xl relative h-72 bg-sky-800 p-5 flex flex-col items-start gap-4">
                        <div className="text-gray-50">
                            <span className="font-bold text-3xl md:text-5xl">Jr</span>
                            <p className="text-xl">Frontend Developer</p>
                            <p className="text-xl font-semibold">Yogesh Arora</p>
                        </div>
                        <a
                            href="/YogeshResume.pdf"
                            download="Yogesh_Arora_Resume.pdf"
                    ...
                    <div className="flex flex-col gap-4 text-center md:text-left">
                        <h1 className="text-xl md:text-3xl font-semibold">📞 : +918427992959</h1>
                        <h1 className="text-lg md:text-2xl font-semibold">📩 : YogeshArora207@gmail.com</h1>
                    </div>
                </div>
            </div>

            <div className="p-6 md:p-20 flex flex-col md:flex-row justify-between items-center">
